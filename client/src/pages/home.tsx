...
// Assets
import phoneImage from "@assets/generated_images/Sleek_matte_black_high-tech_spy_phone_floating_in_zero_gravity_b268cc20.png";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary selection:text-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-bold leading-none mb-6 tracking-tighter">
              <GlitchText text="UNBREAKABLE" /> <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">
                CONNECTION
              </span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-lg mb-8 font-light border-l-2 border-primary/30 pl-6">
              The first AI-native device built for the frontline. 
              Quantum adaptable. Satellite native. Indestructible.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="rounded-none bg-primary text-black hover:bg-primary/90 font-bold tracking-wide px-8 h-14">
                SECURE ACCESS
              </Button>
              <Button size="lg" variant="outline" className="rounded-none border-white/20 hover:bg-white/5 font-mono h-14">
      ...
      {/* Specs Grid */}
      <section id="specs" className="py-32 relative bg-background border-t border-white/5">
        <div className="container mx-auto px-6">
          <motion.div 
            ...
            className="mb-16"
          >
            <h2 className="text-4xl font-bold mb-4">TACTICAL SUPERIORITY</h2>
      ...
      {/* Sentient 1 Section */}
      <section id="sentient" className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="grid grid-cols-2 gap-8 mb-12">
              <div>
                <div className="text-4xl font-bold font-mono text-white mb-2">0.0ms</div>
                <div className="text-sm text-muted-foreground font-mono uppercase">Cloud Latency</div>
              </div>
              <div>
                <div className="text-4xl font-bold font-mono text-white mb-2">100%</div>
                <div className="text-sm text-muted-foreground font-mono uppercase">Offline Capable</div>
              </div>
            </div>

            <Button className="bg-secondary hover:bg-secondary/90 text-white rounded-none h-12 px-8">
              INITIATE INTERFACE
            </Button>
          </div>
        </div>
      ...
      <section className="py-24 bg-primary text-black">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto mb-10 font-medium opacity-80">
          ...
          <form className="max-w-md mx-auto flex gap-0">
            <input 
              ...
              className="flex-1 bg-black text-white px-6 py-4 outline-none border-none placeholder:text-white/40 font-mono text-sm"
            />
            <button className="bg-white text-black px-8 py-4 font-bold hover:bg-black hover:text-white transition-colors uppercase text-sm tracking-wider">
              Deploy
            </button>
          </form>
        </div>
